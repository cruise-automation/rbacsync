...
// ClusterRBACSyncConfigs returns a ClusterRBACSyncConfigInformer.
func (v *version) ClusterRBACSyncConfigs() ClusterRBACSyncConfigInformer {
	return &clusterRBACSyncConfigInformer{factory: v.factory, tweakListOptions: v.tweakListOptions}
}

// RBACSyncConfigs returns a RBACSyncConfigInformer.
func (v *version) RBACSyncConfigs() RBACSyncConfigInformer {
	return &rBACSyncConfigInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
