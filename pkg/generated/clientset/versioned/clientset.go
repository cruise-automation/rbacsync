...
import (
	rbacsyncv1alpha "github.com/cruise-automation/rbacsync/pkg/generated/clientset/versioned/typed/rbacsync/v1alpha"
...
type Clientset struct {
	*discovery.DiscoveryClient
	rBACSyncV1alpha *rbacsyncv1alpha.RBACSyncV1alphaClient
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.rBACSyncV1alpha, err = rbacsyncv1alpha.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.rBACSyncV1alpha = rbacsyncv1alpha.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.rBACSyncV1alpha = rbacsyncv1alpha.New(c)
